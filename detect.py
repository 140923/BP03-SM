...
# Input image 
# image = cv2.imread('C:\Users\surya\Downloads\Gender-and-Age-detection\Gender-and-Age-Detection-master\girl1.jpg') 
image = cv2.imread('C:/Users/surya/Downloads/Gender-and-Age-detection/Gender-and-Age-Detection-master/girl1.jpg')
...
# Using models 
# Face 
face = cv2.dnn.readNet(faceModel, face1) 
  
# age 
age = cv2.dnn.readNet(ageModel, ageProto) 
  
# gender 
gen = cv2.dnn.readNet(gen2, genderProto) 
